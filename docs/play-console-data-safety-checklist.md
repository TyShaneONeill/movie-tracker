...
- **Open questions:** 8 originally — #1 (email), #3 (Facebook), #4 (AdMob Android), #6 (ticket photo persistence), #8 (deletion SLA) all resolved 2026-05-28; #2 (analytics opt-out) resolved by shipping toggle on this branch; **only #5 (Gemini retention tier) and #7 (AI feature box declaration) remain** — both require a one-line user confirmation, no code work.
