...
interface DiscoveryMovieCardProps {
  movieTitle: string;
...
const DiscoveryMovieCard = React.forwardRef<View, DiscoveryMovieCardProps>(
  ({ movieTitle, posterPath, releaseYear, tagline, shareUrl }, ref) => {
...
DiscoveryMovieCard.displayName = 'DiscoveryMovieCard';
...
export { DiscoveryMovieCard };
export default DiscoveryMovieCard;
