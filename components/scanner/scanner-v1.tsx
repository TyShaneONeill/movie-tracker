 ...
 *
 * NOTE: This is the verbatim v1 scanner body, extracted unchanged from
 * `app/(tabs)/scanner.tsx` so the Ticket Scan v2 feature flag can gate between
 * v1 (this component) and v2 without any behavior change when the flag is off.
 * The only edit vs. the original is the export form (`export function ScannerV1`
 * instead of `export default function ScannerScreen`).
 */
